...
### 🔗 Посилання на проект
Live Demo: [rental-car-eight-flax.vercel.app](https://rental-car-eight-flax.vercel.app/) </br>
...
Система "Обране": 
        ...
        Можливість додавати авто в список улюблених. Списки зберігаються в localStorage і не зникають після оновлення сторінки.
